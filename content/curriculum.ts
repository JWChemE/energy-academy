        ...
        modules: [
          {
            ...
            lessons: [
              { slug: "how-chp-works", title: "How CHP Works", summary: "Engine/turbine + generator produce electricity; waste heat recovered for heating/DHW.", minutes: 11, reviewed: "2026-07-04" },
              { slug: "chp-technologies", title: "CHP Technologies (Gas, Biomass)", summary: "Reciprocating engines, microturbines, Stirling engines; pros and cons; typical sizes.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "efficiency-metrics", title: "Efficiency Metrics & Losses", summary: "Electrical efficiency, heat recovery efficiency, overall efficiency, stack losses.", minutes: 10, reviewed: "2026-07-04" },
          ...
          },
          {
            ...
            lessons: [
              { slug: "heat-demand", title: "Sizing to Heat Demand (Not Electricity)", summary: "CHP should be sized to annual heat demand curve; oversizing = wasted electricity export.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "load-profile", title: "Load Profile Analysis", summary: "Thermal and electrical demand matching; seasonal variation; identifying steady base load.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "system-integration", title: "CHP Integration with Boiler/Chiller", summary: "Hybrid operation: CHP for baseload heat, boiler backup for peaks; sequencing controls.", minutes: 10, reviewed: "2026-07-04" },
          ...
          },
          {
            ...
            lessons: [
              { slug: "cost-benefit", title: "Cost-Benefit Analysis", summary: "Capital cost, fuel cost, electricity export revenue (or avoided grid purchase); 10-year payback.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "grid-export", title: "Grid Connection & Export Revenue", summary: "Metering, export tariffs (export price vs avoided import cost), DNO approval.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "carbon-assessment", title: "Carbon Payback & Lifecycle", summary: "Manufacturing carbon, fuel carbon, electricity displacement; payback period.", minutes: 10, reviewed: "2026-07-04" },
        ...
        modules: [
          {
            ...
            lessons: [
              { slug: "why-expensive", title: "Why Compressed Air is Expensive", summary: "Energy cost of compression, inefficiencies, why it's often overlooked.", minutes: 9, reviewed: "2026-07-04" },
              { slug: "compressor-types", title: "Compressor Types & Efficiency", summary: "Reciprocating, screw, rotary vane; energy efficiency and performance.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "pressure-flow", title: "Pressure, Flow & Energy Loss", summary: "Bar, CFM, power; how pressure drop wastes energy.", minutes: 10, reviewed: "2026-07-04" },
          ...
          },
          {
            ...
            lessons: [
              { slug: "pipe-sizing", title: "Piping, Drying & Air Quality", summary: "Pipe diameter, drying (refrigerant vs desiccant), filtration, moisture removal.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "leaks-detection", title: "Leak Detection & Sealing", summary: "How leaks waste energy, ultrasonic detection, ROI of leak repair.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "pressure-regulation", title: "Pressure Regulation & Control", summary: "System pressure, modulation, load-unload control, variable-displacement compressors.", minutes: 10, reviewed: "2026-07-04" },
          ...
          },
          {
            ...
            lessons: [
              { slug: "maintenance", title: "Maintenance & Efficiency Retention", summary: "Filter replacement, oil analysis, bearing care, preventive maintenance.", minutes: 9, reviewed: "2026-07-04" },
              { slug: "heat-recovery", title: "Waste Heat Recovery from Compressed Air", summary: "Compressor discharge is 80–100°C; recovery for DHW or space heating.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "improvement-projects", title: "Common Improvement Projects", summary: "Speed controllers (VFD), variable-displacement compressors, audits.", minutes: 9, reviewed: "2026-07-04" },
        ...
        modules: [
          {
            ...
            lessons: [
              { slug: "sensible-latent", title: "Sensible & Latent Thermal Storage", summary: "Heating/cooling water vs phase-change materials; capacity and density.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "load-shifting", title: "Load Shifting & Peak Reduction", summary: "Storing heat off-peak (cheap rate) for peak use; demand management.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "seasonal-storage", summary: "Storing summer heat for winter use (seasonal storage); long-term strategies.", title: "Seasonal Storage", minutes: 10, reviewed: "2026-07-04" },
          ...
          },
          {
            ...
            lessons: [
              { slug: "water-tanks", title: "Water Tanks (Thermal Mass)", summary: "Hot water tanks for DHW, thermal storage; sizing, insulation, stratification.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "phase-change", title: "Phase-Change Materials & Ice Storage", summary: "PCM (paraffin, salt hydrates), ice-on-coil, latent heat density.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "ground-storage", title: "Ground & Aquifer Thermal Storage", summary: "Boreholes, aquifer storage, seasonal shifting from ground.", minutes: 10, reviewed: "2026-07-04" },
          ...
          },
          {
            ...
            lessons: [
              { slug: "dhw-heating", title: "Domestic Hot Water & Space Heating Storage", summary: "Buffer tanks for boiler cycling, off-peak charging, solar integration.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "cooling-storage", title: "Cooling Load Storage (Ice/Chilled Water)", summary: "Night cooling for day use; reduced chiller size and peak demand.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "economics-payback", title: "Economics & Payback Analysis", summary: "Cost of storage vs energy savings, tariff structures, incentives.", minutes: 10, reviewed: "2026-07-04" },
        ...
        modules: [
          {
            ...
            lessons: [
              { slug: "pv-basics", title: "How Solar PV Works", summary: "Photons, silicon, cells, modules, string inverters; efficiency limits.", minutes: 11, reviewed: "2026-07-04" },
              { slug: "pv-sizing", title: "Sizing a PV System", summary: "Available roof area, orientation, shading, kWp rating, annual yield.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "pv-integration", title: "Grid Interconnection & Battery Storage", summary: "Grid-tied inverters, export metering, batteries for off-grid or resilience.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "pv-economics", title: "PV Economics & Payback", summary: "Cost per Wp, FiT/export income, payback period, 25-year lifetime value.", minutes: 10, reviewed: "2026-07-04" },
          ...
          },
          {
            ...
            lessons: [
              { slug: "solar-thermal", title: "Solar Thermal (Hot Water Heating)", summary: "Flat-plate collectors, evacuated tubes, COP, seasonal variation, DHW tanks.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "wind", title: "Wind Turbines (Small-Scale)", summary: "Wind potential, turbine types, noise, visual impact, planning constraints.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "heat-pump-renewable", title: "Heat Pumps as Renewable (COP as Leverage)", summary: "How heat pumps use renewable electricity more efficiently than direct heat.", minutes: 9, reviewed: "2026-07-04" },
          ...
          },
          {
            ...
            lessons: [
              { slug: "biomass", title: "Biomass Boilers & Heating", summary: "Wood chips, pellets, carbon neutrality, supply chain, efficiency.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "hybrid-systems", title: "Hybrid Systems (Fossil + Renewable)", summary: "Boiler + heat pump, PV + grid, diversity for resilience.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "microgrid", title: "Local Generation & Microgrids", summary: "Peer-to-peer export, virtual power plants, community solar.", minutes: 9, reviewed: "2026-07-04" },
          ...
          },
          {
            ...
            lessons: [
              { slug: "grid-codes", title: "Grid Code Requirements & Export Metering", summary: "DNO approval, export capacity, anti-islanding, metering standards.", minutes: 9, reviewed: "2026-07-04" },
              { slug: "battery-storage", title: "Battery Storage for Self-Consumption & Demand Shifting", summary: "Lithium-ion, lead-acid, round-trip efficiency, depth of discharge.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "net-zero-pathway", title: "Pathway to Net-Zero (Retrofit Sequencing)", summary: "Insulation → electrification → renewable generation → storage.", minutes: 10, reviewed: "2026-07-04" },
        ...
        modules: [
          {
            ...
            lessons: [
              ...
              {
                slug: "retro-commissioning-existing",
                title: "Retro-Commissioning Existing Buildings",
                summary: "Retro-commissioning and monitoring-based commissioning to recover performance in existing buildings.",
                minutes: 10,
                reviewed: "2026-07-04",
              },
              {
        ...
        modules: [
          {
            ...
            lessons: [
              { slug: "planned-reactive", title: "Planned vs Reactive Maintenance", summary: "Preventive maintenance keeps equipment efficient; reactive (breakdown) repair is costly and inefficient.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "energy-performance", title: "How Maintenance Affects Energy Performance", summary: "Fouling, wear, leaks, friction; maintenance intervals that protect efficiency.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "maintenance-checklist", title: "Energy-Focused Maintenance Checklist", summary: "Boiler, chiller, pump, motor, compressor; what to inspect/clean/adjust for peak performance.", minutes: 10, reviewed: "2026-07-04" },
          ...
          },
          {
            ...
            lessons: [
              { slug: "boiler-maintenance", title: "Boiler & Fuel System Maintenance", summary: "Cleaning, scaling removal, combustion tuning, pressure relief testing; efficiency loss timeline.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "chiller-cooling", title: "Chiller & Cooling System Maintenance", summary: "Condenser cleaning, refrigerant charge, superheat/subcooling check, filter change.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "motor-pump", title: "Motor & Pump Maintenance", summary: "Bearing lubrication, seal inspection, vibration monitoring; early fault detection.", minutes: 10, reviewed: "2026-07-04" },
          ...
          },
          {
            ...
            lessons: [
              { slug: "condition-monitoring", title: "Condition Monitoring & Predictive Maintenance", summary: "Vibration, temperature, efficiency trending; early fault detection; avoid catastrophic failure.", minutes: 10, reviewed: "2026-07-04" },
              { slug: "maintenance-plan", title: "Maintenance Plan Development", summary: "Equipment inventory, maintenance intervals, cost budgeting, scheduling (seasonal).", minutes: 10, reviewed: "2026-07-04" },
              { slug: "performance-tracking", title: "Performance Tracking & KPIs", summary: "Equipment efficiency over time (boiler flue temp, motor current, chiller COP); trend analysis.", minutes: 10, reviewed: "2026-07-04" },
