...
export const TES_CASES: TesCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["oversized-store", "sensible-too-bulky", "storage-adequate", "storage-undervalued"],
    correctCauseIds: ["sensible-too-bulky"],
    candidateActionIds: ["bigger-tank", "run-plant-peak", "use-ice-latent", "install-thermal-store"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["storage-undervalued", "oversized-store", "storage-adequate", "flat-tariff"],
    correctCauseIds: ["storage-undervalued"],
    candidateActionIds: ["dont-install", "install-thermal-store", "run-plant-peak", "downsize-plant"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateCauseIds: ["flat-tariff", "storage-adequate", "oversized-store", "storage-undervalued"],
    correctCauseIds: ["flat-tariff"],
    candidateActionIds: ["bigger-tank", "get-tou-tariff", "install-thermal-store", "dont-install"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateCauseIds: ["standing-losses", "poor-stratification", "storage-adequate", "oversized-store"],
    correctCauseIds: ["poor-stratification"],
    candidateActionIds: ["install-thermal-store", "insulate-store", "bigger-tank", "fix-stratification"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["poor-stratification", "standing-losses", "storage-adequate", "oversized-store"],
    correctCauseIds: ["standing-losses"],
    candidateActionIds: ["insulate-store", "bigger-tank", "run-plant-peak", "fix-stratification"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["standing-losses", "storage-adequate", "oversized-store", "seasonal-too-small"],
    correctCauseIds: ["seasonal-too-small"],
    candidateActionIds: ["insulate-store", "install-thermal-store", "bigger-tank", "district-scale-only"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateCauseIds: ["storage-adequate", "flat-tariff", "wrong-charge-schedule", "storage-undervalued"],
    correctCauseIds: ["wrong-charge-schedule"],
    candidateActionIds: ["bigger-tank", "reschedule-charging", "run-plant-peak", "install-thermal-store"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["sensible-too-bulky", "oversized-store", "pcm-wrong-temp", "storage-adequate"],
    correctCauseIds: ["pcm-wrong-temp"],
    candidateActionIds: ["add-more-pcm", "install-thermal-store", "select-correct-pcm", "bigger-tank"],
