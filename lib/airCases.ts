...
export const AIR_CASES: AirCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["poor-partload-control", "compressor-fault", "air-leaks", "pressure-too-high"],
    correctCauseIds: ["air-leaks"],
    candidateActionIds: ["raise-pressure", "leak-survey", "bigger-compressor", "fit-leak-monitoring"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["full-demand", "air-leaks", "undersized-compressor", "poor-partload-control"],
    correctCauseIds: ["poor-partload-control"],
    candidateActionIds: ["fit-vsd-compressor", "raise-pressure", "switch-off-offhours", "bigger-compressor"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateCauseIds: ["full-demand", "air-leaks", "pressure-too-high", "excessive-pressure-drop"],
    correctCauseIds: ["pressure-too-high"],
    candidateActionIds: ["bigger-compressor", "raise-pressure", "fit-regulators", "reduce-pressure"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateCauseIds: ["air-leaks", "full-demand", "inappropriate-use", "pressure-too-high"],
    correctCauseIds: ["inappropriate-use"],
    candidateActionIds: ["bigger-compressor", "reduce-pressure", "replace-with-blower", "leak-survey"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["air-leaks", "heat-not-recovered", "poor-partload-control", "pressure-too-high"],
    correctCauseIds: ["heat-not-recovered"],
    candidateActionIds: ["fit-heat-recovery", "reduce-pressure", "bigger-compressor", "leak-survey"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["air-leaks", "compressor-fault", "excessive-pressure-drop", "pressure-too-high"],
    correctCauseIds: ["excessive-pressure-drop"],
    candidateActionIds: ["bigger-compressor", "reduce-pressure", "replace-filters", "raise-pressure"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateCauseIds: ["air-leaks", "full-demand", "undersized-compressor", "no-sequencing"],
    correctCauseIds: ["no-sequencing"],
    candidateActionIds: ["fit-sequencer", "bigger-compressor", "raise-pressure", "fit-vsd-trim"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["compressor-fault", "air-leaks", "drain-air-loss", "pressure-too-high"],
    correctCauseIds: ["drain-air-loss"],
    candidateActionIds: ["fit-zero-loss-drains", "reduce-pressure", "bigger-compressor", "leak-survey"],
