...
export const COMMX_CASES: CommxCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["unbalanced-flow", "chiller-underperforms", "design-flaw", "commissioning-passed"],
    correctCauseIds: ["unbalanced-flow"],
    candidateActionIds: ["balance-system", "accept-handover", "replace-equipment", "raise-output"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["chiller-underperforms", "unbalanced-flow", "commissioning-passed", "design-flaw"],
    correctCauseIds: ["chiller-underperforms"],
    candidateActionIds: ["remedy-and-retest", "accept-handover", "raise-output", "replace-equipment"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateCauseIds: ["sequence-defect", "default-setpoints", "design-flaw", "commissioning-passed"],
    correctCauseIds: ["sequence-defect"],
    candidateActionIds: ["fix-sequence-retest", "accept-handover", "defer", "raise-output"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateCauseIds: ["uncalibrated-sensor", "default-setpoints", "commissioning-passed", "design-flaw"],
    correctCauseIds: ["uncalibrated-sensor"],
    candidateActionIds: ["calibrate-sensor", "accept-handover", "replace-equipment", "raise-output"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["default-setpoints", "uncalibrated-sensor", "commissioning-passed", "design-flaw"],
    correctCauseIds: ["default-setpoints"],
    candidateActionIds: ["set-to-design", "accept-handover", "raise-output", "replace-equipment"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["excess-duct-pressure", "unbalanced-flow", "commissioning-passed", "design-flaw"],
    correctCauseIds: ["excess-duct-pressure"],
    candidateActionIds: ["reset-static-pressure", "accept-handover", "replace-equipment", "raise-output"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateCauseIds: ["commissioning-drift", "design-flaw", "commissioning-passed", "chiller-underperforms"],
    correctCauseIds: ["commissioning-drift"],
    candidateActionIds: ["recommission", "accept-handover", "replace-equipment", "raise-output"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["poor-handover", "commissioning-drift", "commissioning-passed", "design-flaw"],
    correctCauseIds: ["poor-handover"],
    candidateActionIds: ["document-and-train", "accept-handover", "replace-equipment", "defer"],
