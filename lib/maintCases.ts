...
export const MAINT_CASES: MaintCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["reactive-on-critical", "deferred-maintenance", "fireside-fouling", "maintenance-adequate"],
    correctCauseIds: ["deferred-maintenance"],
    candidateActionIds: ["do-the-maintenance", "run-to-failure", "defer-again", "replace-equipment"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["maintenance-adequate", "deferred-maintenance", "fireside-fouling", "belt-slip"],
    correctCauseIds: ["fireside-fouling"],
    candidateActionIds: ["replace-equipment", "defer-again", "clean-fireside", "run-to-failure"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateCauseIds: ["fireside-fouling", "reactive-on-critical", "deferred-maintenance", "maintenance-adequate"],
    correctCauseIds: ["reactive-on-critical"],
    candidateActionIds: ["replace-equipment", "run-to-failure", "defer-again", "switch-to-preventive"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateCauseIds: ["belt-slip", "reactive-on-critical", "developing-fault", "maintenance-adequate"],
    correctCauseIds: ["developing-fault"],
    candidateActionIds: ["defer-again", "run-to-failure", "replace-equipment", "predictive-intervene"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["interval-too-long", "developing-fault", "belt-slip", "maintenance-adequate"],
    correctCauseIds: ["belt-slip"],
    candidateActionIds: ["run-to-failure", "defer-again", "replace-equipment", "retension-belts"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["deferred-maintenance", "maintenance-adequate", "interval-too-long", "belt-slip"],
    correctCauseIds: ["interval-too-long"],
    candidateActionIds: ["replace-equipment", "run-to-failure", "spread-evenly", "shorten-interval"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateCauseIds: ["maintenance-adequate", "reactive-on-critical", "fireside-fouling", "accumulated-drift"],
    correctCauseIds: ["accumulated-drift"],
    candidateActionIds: ["maintenance-catchup", "run-to-failure", "replace-equipment", "defer-again"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["deferred-maintenance", "misallocated-maintenance", "reactive-on-critical", "maintenance-adequate"],
    correctCauseIds: ["misallocated-maintenance"],
    candidateActionIds: ["run-to-failure", "spread-evenly", "replace-equipment", "prioritise-significant-users"],
