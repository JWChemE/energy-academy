...
export const MOTOR_CASES: MotorCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["oversized-motor", "correctly-loaded", "belt-losses", "voltage-imbalance"],
    correctCauseIds: ["oversized-motor"],
    candidateActionIds: ["right-size-motor", "fit-pfc", "rewind-again", "fit-vsd"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["damper-throttled", "full-flow-needed", "oversized-motor", "belt-losses"],
    correctCauseIds: ["damper-throttled"],
    candidateActionIds: ["fit-vsd", "open-damper", "right-size-motor", "upgrade-belts"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateCauseIds: ["rewound-degraded", "correctly-loaded", "oversized-motor", "belt-losses"],
    correctCauseIds: ["rewound-degraded"],
    candidateActionIds: ["replace-with-ie3", "rewind-again", "fit-vsd", "fit-pfc"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateCauseIds: ["poor-pf", "oversized-motor", "idle-no-control", "voltage-imbalance"],
    correctCauseIds: ["poor-pf"],
    candidateActionIds: ["fit-pfc", "right-size-fleet", "replace-motor", "fit-vsd"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["idle-no-control", "oversized-motor", "damper-throttled", "belt-losses"],
    correctCauseIds: ["idle-no-control"],
    candidateActionIds: ["fit-interlock", "fit-vsd", "replace-motor", "right-size-motor"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["belt-losses", "oversized-motor", "damper-throttled", "voltage-imbalance"],
    correctCauseIds: ["belt-losses"],
    candidateActionIds: ["upgrade-belts", "fit-vsd", "replace-motor", "rewind-again"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateCauseIds: ["upgrade-opportunity", "rewound-degraded", "oversized-motor", "overloaded"],
    correctCauseIds: ["upgrade-opportunity"],
    candidateActionIds: ["replace-on-failure-ie4", "replace-now-ie4", "rewind-again", "fit-vsd"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["voltage-imbalance", "bearing-fault", "oversized-motor", "overloaded"],
    correctCauseIds: ["voltage-imbalance"],
    candidateActionIds: ["correct-voltage-imbalance", "replace-motor", "rewind-again", "fit-vsd"],
