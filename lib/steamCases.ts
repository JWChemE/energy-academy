...
export const STEAM_CASES: SteamCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["condensate-to-drain", "process-leak", "trap-failed-open", "insulation-missing"],
    correctCauseIds: ["condensate-to-drain"],
    candidateActionIds: ["fix-condensate-route", "pumped-condensate-return", "repair-trap", "relag-pipework"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["over-cautious-dump", "process-leak", "condensate-to-drain", "trap-failed-open"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateCauseIds: ["trap-failed-open", "trap-failed-closed", "flash-vented", "insulation-missing"],
    correctCauseIds: ["trap-failed-open", "trap-failed-closed"],
    candidateActionIds: ["repair-trap", "fit-trap-monitoring", "relag-pipework", "fit-flash-recovery"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateCauseIds: ["flash-vented", "trap-failed-open", "insulation-missing", "distribution-pressure-high"],
    correctCauseIds: ["flash-vented"],
    candidateActionIds: ["fit-flash-recovery", "repair-trap", "relag-pipework", "reduce-distribution-pressure"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["insulation-missing", "distribution-pressure-high", "flash-vented", "trap-failed-open"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["distribution-pressure-high", "flash-vented", "insulation-missing", "trap-failed-open"],
    correctCauseIds: ["distribution-pressure-high"],
    candidateActionIds: ["reduce-distribution-pressure", "fit-flash-recovery", "relag-pipework", "repair-trap"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateActionIds: ["fit-pump-trap", "fit-vacuum-breaker", "repair-trap", "reduce-distribution-pressure"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["carryover-boiler", "poor-separation", "trap-failed-open", "stall"],
    correctCauseIds: ["carryover-boiler", "poor-separation"],
    candidateActionIds: ["control-boiler-tds", "fit-separator", "repair-trap", "fit-flash-recovery"],
