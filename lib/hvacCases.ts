...
export const HVAC_CASES: HvacCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["fouled-condenser", "oa-unsuitable", "no-static-reset", "economiser-disabled"],
    correctCauseIds: ["economiser-disabled"],
    candidateActionIds: ["enthalpy-control", "clean-filters", "add-cooling", "enable-economiser"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["no-dcv", "sensor-drift", "min-oa-correct", "sat-too-low"],
    correctCauseIds: ["no-dcv"],
    candidateActionIds: ["add-heating", "clean-filters", "reset-min-oa", "fit-dcv"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateCauseIds: ["deadband-tight", "sat-too-low", "reheat-valve-failed", "fouled-condenser"],
    correctCauseIds: ["sat-too-low"],
    candidateActionIds: ["add-cooling", "raise-sat", "repair-reheat-valve", "widen-deadband"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateCauseIds: ["no-static-reset", "fouled-condenser", "fan-oversized", "dirty-filters"],
    correctCauseIds: ["no-static-reset"],
    candidateActionIds: ["trim-fan", "clean-filters", "replace-chiller", "static-reset"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["pump-throttled", "fouled-condenser", "oa-unsuitable", "no-static-reset"],
    correctCauseIds: ["pump-throttled"],
    candidateActionIds: ["clean-filters", "add-cooling", "open-balancing", "fit-vsd"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["no-static-reset", "fouled-condenser", "low-refrigerant", "no-chw-reset"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateCauseIds: ["fouled-condenser", "no-dcv", "no-schedule", "override-on"],
    correctCauseIds: ["no-schedule"],
    candidateActionIds: ["add-heating", "set-schedule", "replace-chiller", "optimum-start"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["sensor-drift", "fouled-condenser", "no-schedule", "undersized-heating"],
    correctCauseIds: ["sensor-drift"],
    candidateActionIds: ["raise-sat", "add-heating", "replace-chiller", "recalibrate-sensor"],
