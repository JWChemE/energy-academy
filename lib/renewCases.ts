...
export const RENEW_CASES: RenewCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["pv-opportunity", "oversized-export", "poor-orientation", "renewable-adequate"],
    correctCauseIds: ["pv-opportunity"],
    candidateActionIds: ["install-pv", "add-battery", "use-tall-mast", "do-nothing"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["oversized-export", "pv-opportunity", "low-self-consumption", "renewable-adequate"],
    correctCauseIds: ["oversized-export"],
    candidateActionIds: ["size-to-demand", "fill-whole-roof", "add-battery", "install-pv"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateCauseIds: ["series-shading", "poor-orientation", "undetected-fault", "renewable-adequate"],
    correctCauseIds: ["series-shading"],
    candidateActionIds: ["fit-optimisers", "ignore-shading", "add-more-panels", "do-nothing"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateCauseIds: ["surplus-exported", "oversized-export", "low-self-consumption", "renewable-adequate"],
    correctCauseIds: ["surplus-exported"],
    candidateActionIds: ["add-battery", "fill-whole-roof", "shift-loads-midday", "do-nothing"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["poor-wind-site", "pv-opportunity", "undetected-fault", "renewable-adequate"],
    correctCauseIds: ["poor-wind-site"],
    candidateActionIds: ["dont-roof-mount", "use-tall-mast", "do-nothing", "add-more-panels"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["low-self-consumption", "oversized-export", "surplus-exported", "renewable-adequate"],
    correctCauseIds: ["low-self-consumption"],
    candidateActionIds: ["shift-loads-midday", "add-more-panels", "add-battery", "do-nothing"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateCauseIds: ["undetected-fault", "series-shading", "poor-orientation", "renewable-adequate"],
    correctCauseIds: ["undetected-fault"],
    candidateActionIds: ["fit-monitoring", "do-nothing", "add-more-panels", "fill-whole-roof"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["poor-orientation", "oversized-export", "series-shading", "renewable-adequate"],
    correctCauseIds: ["poor-orientation"],
    candidateActionIds: ["reorient-eastwest", "fill-whole-roof", "do-nothing", "install-pv"],
