...
export const MV_CASES: MvCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["raw-comparison-ok", "weather-luck", "needs-normalised-baseline", "mv-sound"],
    correctCauseIds: ["needs-normalised-baseline"],
    candidateActionIds: ["report-normalised-saving", "claim-raw-saving", "claim-inflated", "use-option-a"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["raw-comparison-ok", "mv-sound", "multi-driver", "needs-normalised-baseline"],
    correctCauseIds: ["multi-driver"],
    candidateActionIds: ["use-multivariable-baseline", "claim-raw-saving", "claim-inflated", "normalise-for-weather"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateActionIds: ["normalise-for-weather", "use-option-a", "claim-inflated", "claim-raw-saving"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateActionIds: ["use-isolation-submetering", "report-normalised-saving", "use-option-a", "claim-inflated"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["weather-luck", "needs-normalised-baseline", "mv-sound", "boundary-change"],
    correctCauseIds: ["boundary-change"],
    candidateActionIds: ["make-non-routine-adjustment", "normalise-for-weather", "claim-inflated", "report-normalised-saving"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["weather-luck", "needs-normalised-baseline", "saving-below-noise", "mv-sound"],
    correctCauseIds: ["saving-below-noise"],
    candidateActionIds: ["normalise-for-weather", "report-normalised-saving", "claim-inflated", "use-isolation-submetering"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateCauseIds: ["persistence-decay", "weather-luck", "mv-sound", "needs-normalised-baseline"],
    correctCauseIds: ["persistence-decay"],
    candidateActionIds: ["report-normalised-saving", "claim-inflated", "ongoing-verification", "claim-lifetime-from-year1"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["mv-sound", "saving-below-noise", "weather-luck", "rebound-effect"],
    correctCauseIds: ["rebound-effect"],
    candidateActionIds: ["report-measured-explain-rebound", "claim-lifetime-from-year1", "force-to-prediction", "claim-inflated"],
