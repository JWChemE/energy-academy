...
export const CASES: DiagnosticCase[] = [
  {
    ...
    candidateCauseIds: ["economiser-fouled", "blowdown-too-low", "tubes-scaled", "air-starved", "excess-air-high"],
    correctCauseIds: ["excess-air-high"],
    candidateActionIds: ["clean-economiser", "increase-blowdown", "descale", "tune-burner"],
...

  {
    ...
    candidateCauseIds: ["excess-air-high", "tubes-scaled", "water-treatment-inadequate", "blowdown-too-low", "no-heat-recovery"],
    correctCauseIds: ["water-treatment-inadequate", "blowdown-too-low", "tubes-scaled"],
    candidateActionIds: ["regenerate-softener", "auto-blowdown", "descale", "upgrade-ro", "fit-economiser", "tune-burner"],
...

  {
    ...
    candidateCauseIds: ["economiser-fouled", "excess-air-high", "no-heat-recovery", "water-treatment-inadequate", "tubes-scaled"],
    correctCauseIds: ["economiser-fouled"],
    candidateActionIds: ["auto-blowdown", "fit-economiser", "descale", "clean-economiser", "tune-burner"],
...

  {
    ...
    candidateCauseIds: ["air-starved", "economiser-fouled", "excess-air-high", "tubes-scaled", "blowdown-too-high"],
    correctCauseIds: ["air-starved"],
    candidateActionIds: ["increase-air", "clean-economiser", "upgrade-ro", "descale", "repair-insulation"],
...

  {
    ...
    candidateCauseIds: ["insulation-poor", "tubes-scaled", "excess-air-high", "economiser-fouled", "oversized-low-load"],
    correctCauseIds: ["oversized-low-load", "insulation-poor"],
    candidateActionIds: ["repair-insulation", "clean-economiser", "tune-burner", "descale", "right-size-load"],
...

  {
    ...
    candidateCauseIds: ["water-treatment-inadequate", "blowdown-too-high", "excess-air-high", "tubes-scaled", "blowdown-too-low"],
    correctCauseIds: ["blowdown-too-high"],
    candidateActionIds: ["descale", "auto-blowdown", "increase-blowdown", "tune-burner"],
