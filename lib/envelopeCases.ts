...
export const ENVELOPE_CASES: EnvelopeCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["fabric-adequate", "uninsulated-cavity", "single-glazing", "uninsulated-roof"],
    correctCauseIds: ["uninsulated-roof"],
    candidateActionIds: ["replace-glazing", "oversize-boiler", "insulate-loft", "cavity-fill"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["fabric-adequate", "solid-wall-uninsulated", "uninsulated-cavity", "air-leakage"],
    correctCauseIds: ["uninsulated-cavity"],
    candidateActionIds: ["survey-suitability", "ext-wall-insulation", "cavity-fill", "oversize-boiler"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateCauseIds: ["fabric-adequate", "uninsulated-roof", "air-leakage", "single-glazing"],
    correctCauseIds: ["air-leakage"],
    candidateActionIds: ["replace-glazing", "add-mvhr", "oversize-boiler", "draught-proof"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateCauseIds: ["fabric-adequate", "thermal-bridging", "penetrating-damp", "air-leakage"],
    correctCauseIds: ["thermal-bridging"],
    candidateActionIds: ["add-controlled-ventilation", "oversize-boiler", "ext-wall-insulation", "treat-thermal-bridges"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["fabric-adequate", "uninsulated-cavity", "solid-wall-uninsulated", "thermal-bridging"],
    correctCauseIds: ["solid-wall-uninsulated"],
    candidateActionIds: ["oversize-boiler", "int-wall-insulation", "cavity-fill", "ext-wall-insulation"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["fabric-adequate", "air-leakage", "single-glazing", "uninsulated-roof"],
    correctCauseIds: ["single-glazing"],
    candidateActionIds: ["replace-glazing", "low-e-coating", "oversize-boiler", "prioritise-cheaper-fabric"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateCauseIds: ["fabric-adequate", "air-leakage", "excess-solar-gain", "single-glazing"],
    correctCauseIds: ["excess-solar-gain"],
    candidateActionIds: ["internal-blinds", "external-shading", "low-e-coating", "solar-control-glazing"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["fabric-adequate", "airtight-no-ventilation", "air-leakage", "penetrating-damp"],
    correctCauseIds: ["airtight-no-ventilation"],
    candidateActionIds: ["oversize-boiler", "draught-proof", "add-mvhr", "add-controlled-ventilation"],
