...
export const PINCH_CASES: PinchCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["no-target-set", "excess-units", "network-appropriate", "wrong-delta-t-min"],
    correctCauseIds: ["no-target-set"],
    candidateActionIds: ["add-more-utility", "accept-as-is", "install-both-utilities", "calculate-and-set-targets"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["no-target-set", "wrong-delta-t-min", "network-appropriate", "cross-pinch-utility"],
    correctCauseIds: ["cross-pinch-utility"],
    candidateActionIds: ["redesign-from-scratch", "accept-as-is", "reroute-utility", "add-more-utility"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateCauseIds: ["infeasible-cp-match", "network-appropriate", "needs-stream-split", "cross-pinch-utility"],
    correctCauseIds: ["infeasible-cp-match"],
    candidateActionIds: ["add-more-utility", "accept-as-is", "redesign-from-scratch", "reject-infeasible-match"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateActionIds: ["split-the-stream", "add-more-utility", "reject-infeasible-match", "redesign-from-scratch"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["cross-pinch-utility", "no-target-set", "threshold-misdiagnosed", "network-appropriate"],
    correctCauseIds: ["threshold-misdiagnosed"],
    candidateActionIds: ["install-both-utilities", "add-more-utility", "accept-as-is", "remove-redundant-utility"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["no-target-set", "cross-pinch-utility", "network-appropriate", "wrong-delta-t-min"],
    correctCauseIds: ["wrong-delta-t-min"],
    candidateActionIds: ["add-more-utility", "rerun-economic-comparison", "accept-as-is", "redesign-from-scratch"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateCauseIds: ["network-appropriate", "needs-stream-split", "excess-units", "wrong-delta-t-min"],
    correctCauseIds: ["excess-units"],
    candidateActionIds: ["redesign-from-scratch", "break-the-loop", "add-more-utility", "accept-as-is"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["network-appropriate", "excess-units", "no-target-set", "cross-pinch-utility"],
    correctCauseIds: ["cross-pinch-utility"],
    candidateActionIds: ["recommend-new-exchanger", "reroute-utility", "add-more-utility", "redesign-from-scratch"],
    correctActionIds: ["reroute-utility"],
