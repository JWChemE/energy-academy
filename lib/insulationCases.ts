...
export const INSULATION_CASES: InsulationCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["over-insulated", "bare-hot-pipe", "insulation-adequate", "bare-valves-fittings"],
    correctCauseIds: ["bare-hot-pipe"],
    candidateActionIds: ["lag-pipe", "over-insulate-max", "do-nothing", "fit-removable-jackets"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["insulation-adequate", "lagging-removed", "bare-valves-fittings", "bare-hot-pipe"],
    correctCauseIds: ["bare-valves-fittings"],
    candidateActionIds: ["fit-removable-jackets", "over-insulate-max", "do-nothing", "lag-pipe"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateCauseIds: ["bare-vessel", "bare-hot-pipe", "material-mismatch", "insulation-adequate"],
    correctCauseIds: ["bare-vessel"],
    candidateActionIds: ["do-nothing", "fit-removable-jackets", "lag-pipe", "lag-vessel"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateCauseIds: ["insulation-adequate", "under-economic-thickness", "bare-hot-pipe", "over-insulated"],
    correctCauseIds: ["under-economic-thickness"],
    candidateActionIds: ["upgrade-to-economic-thickness", "do-nothing", "over-insulate-max", "lag-pipe"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["material-mismatch", "vapour-barrier-breach", "insulation-adequate", "under-economic-thickness"],
    correctCauseIds: ["vapour-barrier-breach"],
    candidateActionIds: ["lag-pipe", "replace-closed-cell-vapour-barrier", "do-nothing", "add-more-mineral-wool"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["insulation-adequate", "bare-hot-pipe", "material-mismatch", "under-economic-thickness"],
    correctCauseIds: ["material-mismatch"],
    candidateActionIds: ["over-insulate-max", "do-nothing", "specify-correct-material", "add-more-mineral-wool"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateCauseIds: ["hot-surface-burn-risk", "bare-hot-pipe", "over-insulated", "insulation-adequate"],
    correctCauseIds: ["hot-surface-burn-risk"],
    candidateActionIds: ["lag-to-safe-touch", "do-nothing", "fit-guarding", "warning-label-only"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["under-economic-thickness", "insulation-adequate", "bare-hot-pipe", "lagging-removed"],
    correctCauseIds: ["lagging-removed"],
    candidateActionIds: ["do-nothing", "over-insulate-max", "fit-removable-jackets", "reinstate-lagging"],
