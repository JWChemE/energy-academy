...
export const CTRL_CASES: CtrlCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["no-scheduling", "no-setpoint-reset", "equipment-fault", "controls-adequate"],
    correctCauseIds: ["no-scheduling"],
    candidateActionIds: ["occupancy-schedule", "fit-sequencing", "replace-plant", "ignore"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["simultaneous-heat-cool", "no-setpoint-reset", "equipment-fault", "controls-adequate"],
    correctCauseIds: ["simultaneous-heat-cool"],
    candidateActionIds: ["add-deadband", "raise-output", "replace-plant", "ignore"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateCauseIds: ["no-setpoint-reset", "no-scheduling", "on-off-control", "controls-adequate"],
    correctCauseIds: ["no-setpoint-reset"],
    candidateActionIds: ["fit-setpoint-reset", "replace-plant", "raise-output", "ignore"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateCauseIds: ["sensor-drift", "no-setpoint-reset", "equipment-fault", "controls-adequate"],
    correctCauseIds: ["sensor-drift"],
    candidateActionIds: ["recalibrate-sensor", "replace-plant", "raise-output", "ignore"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["sensor-placement", "sensor-drift", "equipment-fault", "controls-adequate"],
    correctCauseIds: ["sensor-placement"],
    candidateActionIds: ["relocate-sensor", "add-portable-heaters", "replace-plant", "raise-output"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["on-off-control", "no-setpoint-reset", "equipment-fault", "controls-adequate"],
    correctCauseIds: ["on-off-control"],
    candidateActionIds: ["fit-pid", "replace-plant", "ignore", "raise-output"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateCauseIds: ["low-valve-authority", "on-off-control", "sensor-drift", "controls-adequate"],
    correctCauseIds: ["low-valve-authority"],
    candidateActionIds: ["resize-valve", "raise-output", "replace-plant", "ignore"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["no-sequencing", "no-setpoint-reset", "equipment-fault", "controls-adequate"],
    correctCauseIds: ["no-sequencing"],
    candidateActionIds: ["fit-sequencing", "replace-plant", "raise-output", "ignore"],
