...
export const WHR_CASES: WhrCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["flue-heat-wasted", "condenser-heat-wasted", "recovery-adequate", "no-sink"],
    correctCauseIds: ["flue-heat-wasted"],
    candidateActionIds: ["fit-economiser", "recover-condenser-heat", "vent-to-atmosphere", "clean-hx"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["condenser-heat-wasted", "flue-heat-wasted", "no-sink", "recovery-adequate"],
    correctCauseIds: ["condenser-heat-wasted"],
    candidateActionIds: ["recover-condenser-heat", "add-thermal-store", "vent-to-atmosphere", "fit-economiser"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateCauseIds: ["vent-heat-wasted", "condenser-heat-wasted", "recovery-adequate", "no-sink"],
    correctCauseIds: ["vent-heat-wasted"],
    candidateActionIds: ["fit-hrv", "recover-condenser-heat", "vent-to-atmosphere", "clean-hx"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateCauseIds: ["fouled-hx", "no-sink", "temperature-mismatch", "recovery-adequate"],
    correctCauseIds: ["fouled-hx"],
    candidateActionIds: ["clean-hx", "upsize-hx", "fit-recovery-hx", "vent-to-atmosphere"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["flash-steam-wasted", "vent-heat-wasted", "no-sink", "recovery-adequate"],
    correctCauseIds: ["flash-steam-wasted"],
    candidateActionIds: ["fit-flash-recovery", "recover-condenser-heat", "vent-to-atmosphere", "fit-hrv"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["timing-mismatch", "temperature-mismatch", "no-sink", "recovery-adequate"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateCauseIds: ["process-exhaust-wasted", "flue-heat-wasted", "no-sink", "recovery-adequate"],
    correctCauseIds: ["process-exhaust-wasted"],
    candidateActionIds: ["fit-recovery-hx", "fit-economiser", "vent-to-atmosphere", "clean-hx"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["temperature-mismatch", "timing-mismatch", "no-sink", "recovery-adequate"],
    correctCauseIds: ["temperature-mismatch"],
    candidateActionIds: ["use-for-preheat", "pipe-direct-hot-sink", "heat-pump-upgrade", "vent-to-atmosphere"],
