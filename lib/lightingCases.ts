...
export const LIGHTING_CASES: LightingCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["under-lit", "over-lit", "inefficient-lamps", "correct-as-is"],
    correctCauseIds: ["over-lit"],
    candidateActionIds: ["add-luminaires", "reduce-to-target", "led-retrofit", "relamp-like-for-like"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["magnetic-ballast", "inefficient-lamps", "correct-as-is", "over-lit"],
    correctCauseIds: ["inefficient-lamps"],
    candidateActionIds: ["relamp-like-for-like", "led-retrofit", "add-luminaires", "reduce-to-target"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateActionIds: ["led-retrofit", "fit-scheduling", "add-luminaires", "clean-lighting-strategy"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateActionIds: ["add-luminaires", "fit-occupancy-sensors", "led-retrofit", "fit-daylight-dimming"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["over-lit", "no-daylight-control", "no-occupancy-control", "correct-as-is"],
    correctCauseIds: ["no-daylight-control"],
    candidateActionIds: ["fit-occupancy-sensors", "fit-daylight-dimming", "led-retrofit", "add-luminaires"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["correct-as-is", "magnetic-ballast", "poor-quality-led", "over-lit"],
    correctCauseIds: ["magnetic-ballast"],
    candidateActionIds: ["add-luminaires", "led-retrofit", "fit-electronic-ballasts", "relamp-like-for-like"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateCauseIds: ["poor-quality-led", "no-occupancy-control", "correct-as-is", "controls-not-commissioned"],
    correctCauseIds: ["controls-not-commissioned"],
    candidateActionIds: ["add-luminaires", "recommission-controls", "relamp-like-for-like", "fit-occupancy-sensors"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["correct-as-is", "inefficient-lamps", "magnetic-ballast", "poor-quality-led"],
    correctCauseIds: ["poor-quality-led"],
    candidateActionIds: ["reduce-to-target", "replace-quality-led", "relamp-like-for-like", "add-luminaires"],
