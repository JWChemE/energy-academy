...
export const CHP_CASES: ChpCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["heat-dumped", "oversized-base", "fouled-hx", "heat-demand-fine"],
    correctCauseIds: ["heat-dumped"],
    candidateActionIds: ["run-heat-led", "fit-thermal-store", "add-absorption-chiller", "install-larger-unit"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["narrow-spark", "engine-worn", "heat-demand-fine", "grid-cleaner"],
    correctCauseIds: ["narrow-spark"],
    candidateActionIds: ["review-run-economics", "fit-thermal-store", "mothball-unit", "install-larger-unit"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateCauseIds: ["elec-oversized-export", "ph-mismatch", "heat-demand-fine", "narrow-spark"],
    correctCauseIds: ["elec-oversized-export"],
    candidateActionIds: ["cap-to-elec-base", "add-onsite-elec-load", "increase-export", "install-larger-unit"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateCauseIds: ["no-summer-sink", "oversized-base", "heat-demand-fine", "engine-worn"],
    correctCauseIds: ["no-summer-sink"],
    candidateActionIds: ["add-absorption-chiller", "add-heat-sink", "fit-thermal-store", "install-larger-unit"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["fouled-hx", "engine-worn", "heat-dumped", "controls-fault"],
    correctCauseIds: ["fouled-hx"],
    candidateActionIds: ["service-exhaust-hx", "overhaul-engine", "run-heat-led", "install-larger-unit"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["no-thermal-store", "oversized-base", "engine-worn", "heat-demand-fine"],
    correctCauseIds: ["no-thermal-store"],
    candidateActionIds: ["fit-thermal-store", "run-heat-led", "resize-unit", "increase-export"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateCauseIds: ["grid-cleaner", "heat-demand-fine", "narrow-spark", "engine-worn"],
    correctCauseIds: ["grid-cleaner"],
    candidateActionIds: ["switch-to-biogas", "run-heat-led", "mothball-unit", "increase-export"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["engine-worn", "fouled-hx", "narrow-spark", "heat-demand-fine"],
    correctCauseIds: ["engine-worn"],
    candidateActionIds: ["overhaul-engine", "service-exhaust-hx", "run-heat-led", "install-larger-unit"],
