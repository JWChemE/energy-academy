...
export const ECON_CASES: EconCase[] = [
  // ---------------------------------------------------------------- Case 1
  {
    ...
    candidateCauseIds: ["short-payback", "payback-misleads-long-life", "ignored-time-value", "analysis-sound"],
    correctCauseIds: ["short-payback"],
    candidateActionIds: ["proceed-screen-pass", "reject-on-payback", "discount-cashflows", "reject-project"],
  ...
  // ---------------------------------------------------------------- Case 2
  {
    ...
    candidateCauseIds: ["ignored-time-value", "positive-npv", "short-payback", "analysis-sound"],
    correctCauseIds: ["ignored-time-value"],
    candidateActionIds: ["discount-cashflows", "accept-positive-npv", "pick-highest-irr", "reject-project"],
  ...
  // ---------------------------------------------------------------- Case 3
  {
    ...
    candidateCauseIds: ["positive-npv", "payback-misleads-long-life", "ignored-time-value", "analysis-sound"],
    correctCauseIds: ["positive-npv"],
    candidateActionIds: ["accept-positive-npv", "reject-project", "pick-highest-irr", "reject-on-payback"],
  ...
  // ---------------------------------------------------------------- Case 4
  {
    ...
    candidateActionIds: ["accept-irr-above-hurdle", "reject-project", "pick-lowest-capital", "reject-on-payback"],
  ...
  // ---------------------------------------------------------------- Case 5
  {
    ...
    candidateCauseIds: ["irr-misleads-size", "irr-above-hurdle", "always-cheapest-capital", "analysis-sound"],
    correctCauseIds: ["irr-misleads-size"],
    candidateActionIds: ["pick-highest-npv", "pick-highest-irr", "pick-lowest-capital", "reject-project"],
  ...
  // ---------------------------------------------------------------- Case 6
  {
    ...
    candidateCauseIds: ["payback-misleads-long-life", "short-payback", "ignored-time-value", "analysis-sound"],
    correctCauseIds: ["payback-misleads-long-life"],
    candidateActionIds: ["use-npv-not-payback", "reject-on-payback", "pick-lowest-capital", "reject-project"],
  ...
  // ---------------------------------------------------------------- Case 7
  {
    ...
    candidateCauseIds: ["no-capital", "always-cheapest-capital", "positive-npv", "analysis-sound"],
    correctCauseIds: ["no-capital"],
    candidateActionIds: ["use-loan", "use-esco", "reject-project", "pick-lowest-capital"],
  ...
  // ---------------------------------------------------------------- Case 8
  {
    ...
    candidateCauseIds: ["risk-not-priced", "irr-misleads-size", "always-cheapest-capital", "analysis-sound"],
    correctCauseIds: ["risk-not-priced"],
    candidateActionIds: ["risk-adjust-sequence", "pick-highest-irr", "pick-lowest-capital", "reject-project"],
